...
// node_modules/three/examples/jsm/tsl/display/SSAAPassNode.js
  ...
  setup(builder) {
    ...
    if (passMRT !== null) {
      ...
      for (const name in passMRT.outputNodes) {
        const index = getTextureIndex2(this._sampleRenderTarget.textures, name);
        if (index >= 0) {
          outputs[name] = texture2(this._sampleRenderTarget.textures[index]).mul(this.sampleWeight);
        }
      }
      sampleTexture = mrt2(outputs);
    } else {
      sampleTexture = texture2(this._sampleRenderTarget.texture).mul(this.sampleWeight);
    }
...
var SSAAPassNode_default = SSAAPassNode;
var _JitterVectors = [
  [
    [0, 0]
  ],
...
var ssaaPass = (scene, camera) => nodeObject2(new SSAAPassNode(scene, camera));
export {
  SSAAPassNode_default as default,
  ssaaPass
};
...
three/build/three.tsl.js:
   ...
   *)
*/
//# sourceMappingURL=three_examples_jsm_tsl_display_SSAAPassNode__js.js.map
